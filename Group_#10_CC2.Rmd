...
3. **Mayher Kanwal** - 20549156
    + [BIOL343_CC](https://github.com/mayherkanwal/BIOL343_CC)
4. **Cecilia Stroz** - 20418105
    + [BIOL343_CC](https://github.com/ceciliastroz/BIOL343_CC)
5. **Frida Liveus** - 20629008
    + [BIOL343_CC](https://github.com/frli4243/BIOL343)
...
knitr::kable(area_means, caption = "Mean ovary area by population type")
...
library(ggplot2)
ggplot(aes(x=ovary_area),data=cc1_data) + geom_histogram(binwidth=1) + facet_wrap(~population_type) + labs( x="Ovary area (mm^2)", y = "Frequency") + theme_classic()
```
...
(image here)
![Solanum pimpinellifolium.png file](./images/Solanum%20pimpinellifolium.png): 
Source: 
[Solanum pimpinellifolium website](https://exotic-seeds.com/en/home/wild-tomato-seeds-solanum-pimpinellifolium.html)
